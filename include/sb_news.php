<div class="box-sb">
                    <div class="box-sb-title"><span><a href="product.html">Sản phẩm đang hot</a></span></div>
                    <div class="box-sb-content">
                        <ul>
                            <?php
                                $myDb->loadLatestDetailProduct(" ", "ProductPos", "ASC", 5);  
                                $sbr = $myDb->r;
                                while ($sbproduct = mysqli_fetch_array($sbr, MYSQLI_ASSOC)) {
                                    echo '<li><a href="detail_product-'.$sbproduct['ProductNoName'].'.html">'.$sbproduct['ProductName'].'</a></li>';
                                }                              
                            ?>
                        </ul>
                    </div>
